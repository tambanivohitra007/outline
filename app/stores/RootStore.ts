...
import EvidenceEntriesStore from "./EvidenceEntriesStore";
...
export default class RootStore {
  ...
  emojis: EmojisStore;
  evidenceEntries: EvidenceEntriesStore;
  events: EventsStore;
  groups: GroupsStore;
  groupUsers: GroupUsersStore;
  imports: ImportsStore;
  integrations: IntegrationsStore;
  interventions: InterventionsStore;
  ...
  constructor() {
    ...
    this.registerStore(RecipesStore);
    this.registerStore(ScripturesStore);
