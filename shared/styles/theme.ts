...
export const buildLightTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    placeholder: "#a2b2c3",
    sidebarBackground: "rgb(16, 42, 67)",
    sidebarHoverBackground: "rgb(22, 52, 82)",
    sidebarActiveBackground: "rgb(230, 57, 80)",
    sidebarControlHoverBackground: "rgb(255 255 255 / 12%)",
    sidebarDraftBorder: "rgb(60, 90, 120)",
    sidebarText: "rgb(180, 200, 220)",
