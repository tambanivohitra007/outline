...
const buildBaseTheme = (input: Partial<Colors>) => {
  ...
  return {
    fontFamily:
      "'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, Inter, 'Segoe UI', Roboto, Oxygen, sans-serif",
    fontFamilyMono:
...
export const buildLightTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    placeholder: "#a2b2c3",
    sidebarBackground: "#102a43",
    sidebarHoverBackground: "#1a3a56",
    sidebarActiveBackground: "#243b53",
    sidebarControlHoverBackground: "rgba(255, 255, 255, 0.1)",
    sidebarDraftBorder: "#334e68",
    sidebarText: "#9fb3c8",
...
export const buildDarkTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    placeholder: "#596673",
    sidebarBackground: "#0d2137",
    sidebarHoverBackground: lighten(0.05, "#0d2137"),
    sidebarActiveBackground: lighten(0.09, "#0d2137"),
